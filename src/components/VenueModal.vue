<template>
  <div class="venue-modal">
              ...
              <section class="venue">
                ...
                <div class="venue-info">
                  ...
                  <div class="venue-contact">
                    ...
                    >{{ venue.email }}</a>
                    <a
                      v-if="venue.phone_number"
                      class="venue-phone"
                      :href="`tel:${venue.phone_number}`"
                    >{{ venue.phone_number }}</a>
                  </div>
                  <div class="venue-social">
                    <a
                      v-if="venue.untappd_url"
                      class="btn venue-untappd"
                      :href="venue.untappd_url"
                      target="_blank"
                    >
                      <img src="/static/svg/untappd.svg" />
                      <span>Untappd</span>
                    </a>
                    <a
                      v-if="venue.facebook_page"
                      class="btn venue-facebook"
    ...
    <template v-else-if="venue === false" />
  </div>
</template>
