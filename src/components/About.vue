  ...
  <div class="about">
    ...
    <main>
      <div class="container-fluid">
        ...
        <p
          class="lead"
        >HSV.beer is an open-source project helping Rocket City residents and visitors find draft beer at the many excellent breweries, bars, and retailers in the Huntsville area.</p>
      ...
      <div class="card bg-light mb-4">
        ...
        <p>
          ...
          <a href="https://github.com/hsv-dot-beer" target="_blank">Github</a> with multiple contributors. The founding contributors are Huntsville residents and craft beer lovers Michael Carroll, Drew Winstel, and Drew McDowell.
        </p>
        <p>
          If you want to join the conversation, find us at #hsv-dot-beer on
        ...
        <p class="text-center">
          <a
            ...
            href="https://twitter.com/hsvdotbeer"
            target="_blank"
          >@hsvdotbeer</a>
        </p>
        <hr class="my-5" />
        <p
          class="text-muted"
        >HSV.beer is meant as a reference only and is not responsible for innaccurate information.</p>
        <p
          class="text-muted"
        >Please drink responsibly. Don't forget Lyft and Uber are available in Huntsville. :)</p>
      </div>
    </main>
    ...
    <footer>
      <div class="container-fluid">
        <ul class="list-inline">
          ...
          <li>
            <a href="https://twitter.com/hsvdotbeer" target="_blank">Contact</a>
          </li>
        </ul>
      </div>
    </footer>
